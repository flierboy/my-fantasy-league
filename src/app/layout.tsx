...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/icons/ud-v3-48.png", sizes: "48x48", type: "image/png" },
      { url: "/icons/ud-v3-192.png", sizes: "192x192", type: "image/png" },
      { url: "/icons/ud-v3-512.png", sizes: "512x512", type: "image/png" },
      { url: "/favicon.png", sizes: "48x48", type: "image/png" },
    ],
    apple: [
      {
        url: "/icons/ud-v3-180.png",
        sizes: "180x180",
        type: "image/png",
      },
    ],
