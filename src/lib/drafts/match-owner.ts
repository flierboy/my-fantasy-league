...
const ALIASES: Record<string, string[]> = {
  ...
  "ham bone": ["ham bone", "hamie", "team hamie", "hambone", "ham"],
  bigbrownstain: ["bigbrownstain", "big brown stain", "bbs"],
  "big lloyd": ["big lloyd", "lloyd"],
  whitstits: ["whitstits", "whits tits", "whit"],
  "playoff lock mase": ["playoff lock mase", "mase", "playoff lock"],
  "starvin marvin": ["starvin marvin", "marvin", "starvin"],
